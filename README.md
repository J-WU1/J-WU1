...
| **[🐍 Exploratory Data Analysis](https://github.com/J-WU1/Video-Games-Sales-EDA)** | Deep dive into a dataset using Python libraries to extract statistical trends and correlations. | **Python, Pandas, Seaborn** |
